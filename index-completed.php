...
<a href="index-active.php"><button class="border border-dark bg-light text-dark"> Active </button></a>
<a href="index-completed.php"><button class="border border-info bg-light text-info "> completed </button></a>
